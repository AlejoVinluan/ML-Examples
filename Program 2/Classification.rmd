...
```{r}
plot(training_data$mileage, training_data$price, xlab = "Mileage", ylab = "Price", main="Used Ford Price vs Mileage") #nolint
```
...
accuracy
```
In this instance, the prediction model only had an accuracy of 41.9%. I believe this
...
that the models had accuracies of 99% and 41.9%, respectively. This classification metric
